...
python train_and_eval.py --steps 100000 --N 20000 --seed 10 --lr 1e-4 --num_checkpoints 30 &
python train_and_eval.py --steps 100000 --N 20000 --seed 11 --lr 1e-4 --num_checkpoints 30 &
python train_and_eval.py --steps 100000 --N 20000 --seed 12 --lr 1e-4 --num_checkpoints 30 &
wait